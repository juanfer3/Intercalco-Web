...
class ProductosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create producto" do
    assert_difference('Producto.count') do
      post productos_url, params: { producto: { caracteristica: @producto.caracteristica, nombre: @producto.nombre } }
    end
  ...
  test "should update producto" do
    patch producto_url(@producto), params: { producto: { caracteristica: @producto.caracteristica, nombre: @producto.nombre } }
